  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    signupBtn.addEventListener("click", async () => {
      ...
      try {
        ...
        window.showStatusMessage("Registration successful! You can now log in.", false)
    ...
    loginBtn.addEventListener("click", async () => {
      ...
      try {
        ...
        window.showStatusMessage("Login successful!", false)
  
        // Update UI for logged in user
        window.updateUIForLoggedInUser(mockUser)
